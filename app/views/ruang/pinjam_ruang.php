<div class="form-wrapper">
     <form action="" method="post">
          ...
          <table align="center" class="form-table">
               ...
               <tr>
                    <td>Divisi</td>
                    <td>: <input type="text" name="divisi" id="divisi" disabled></td>
               </tr>
               <tr>
                    <td>Contact</td>
               ...
               <tr>
                    <td>Nama Kegiatan</td>
                    <td>: <input type="text" name="nama_kegiatan" id="nama_kegiatan"></td>
               </tr>
               <tr>
                    <td>Jenis Kegiatan</td>
                    <td>: <select name="jenis_kegiatan" id="jenis_kegiatan">
               ...
               <tr>
                    ...
                    <td>: <input type="datetime" name="awal_kegiatan" id="awal_kegiatan"> s/d</td>
                    <td>: <input type="datetime" name="akhir_kegiatan" id="akhir_kegiatan"></td>
               </tr>
               <tr>
                    <td>Nama Kegiatan</td>
                    <td>: <input type="text" name="jumlah_undangan" id="jumlah_undangan" disabled></td>
               </tr>
               <tr>
                    <td>Ruang</td>
               ...
               <tr>
                    <td>Proposal</td>
                    <td><input type="file" name="proposal" id="proposal"></td>
               </tr>
               <tr>
